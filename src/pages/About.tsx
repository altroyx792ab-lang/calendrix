  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-20">
      ...
      <div className="text-center mb-20">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-accent/10 text-brand-accent border border-brand-accent/20 mb-6">
          <Rocket size={16} />
        ...
        <h1 className="text-5xl md:text-7xl font-display font-bold mb-8 text-white leading-tight">
          Hi, I'm <span className="text-brand-accent italic">Yahya Mughal</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24 items-center">
        <div className="relative group">
          <div className="absolute -inset-4 bg-gradient-to-r from-brand-accent to-blue-500 rounded-3xl blur-2xl opacity-20 group-hover:opacity-40 transition duration-1000"></div>
          <div className="relative aspect-square rounded-3xl overflow-hidden border border-white/10 bg-slate-900 flex items-center justify-center p-12">
            <div className="text-center">
              <Code size={80} className="text-brand-accent mx-auto mb-6" />
              <div className="space-y-2">
                <p className="text-2xl font-bold font-display text-white">Professional Vibe Coder</p>
                <p className="text-brand-accent font-medium">Digital Marketer</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Website Purpose */}
      <div className="bg-gradient-to-br from-brand-accent/20 to-blue-900/20 border border-white/10 rounded-[3rem] p-8 md:p-16 mb-24">
        <div className="max-w-3xl mx-auto text-center">
          <Globe className="w-12 h-12 text-brand-accent mx-auto mb-8" />
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <span className="px-6 py-2 bg-brand-accent/10 border border-brand-accent/20 rounded-full text-brand-accent text-sm font-bold uppercase tracking-widest">Time Management</span>
